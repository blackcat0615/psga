...
BATCH_SIZE=${1:-8}
LEARNING_COEF=${2:-0.1}
OUTPUT_DIR=${3:-/root/gpufree-data/sim_vla/SimVLA/runs/simvla_libero_small_psga}
RESUME_CKPT=${4:-""}
...
# Path configuration
# =============================================================================
LIBERO_DATA_DIR="/root/gpufree-data/sim_vla/SimVLA/datasets/metas"
...
USE_CROSS_ATT=true          # use_cross_att
...
# Add cross_att flag if enabled
if [ "${USE_CROSS_ATT}" = true ]; then
    ARGS="${ARGS} --use_cross_att"
fi
...
echo "   Use USE_CROSS_ATT: ${USE_CROSS_ATT}"
echo "============================================================"
